...
CREATE TABLE IF NOT EXISTS `ap_items` (
  ...
  `pickraten511` int(255) NOT NULL,
  `winraten511` int(255) NOT NULL,
  `pickraten514` int(255) NOT NULL,
  `winraten514` int(255) NOT NULL
...
(82, 'ahmed', 2, 266, '2078.079', 'testMatch.json', 8, 1440702654, 6, 0),
(83, 'hgnmhjhk', 2, 266, '1707.230', 'testMatch.json', 5, 1440703345, 5, 0),
(84, 'test', 1, 266, '1250.804', 'testMatch.json', 8, 1440818094, 6, 0);
...
ALTER TABLE `ap_items`
  ADD PRIMARY KEY (`id`), ADD KEY `item_id` (`id`);
