...
<html lang="en">
    ...
    <head>
        ...
        <title>Riot Project v2 - About Us</title>
    ...
    <body>
        ...
        <div class="container topmargin">
            ...
            <div class="row">
                <div class="col-lg-6" style="background-color: #9D9D9D;">
                    <div class="widget-head-color-box navy-bg p-lg text-center">
                        <div class="m-b-md">
                            <h2 style="color:black;" class="font-bold no-margins">
                                Ahmed Safadi
                            </h2>
                            <Br />
                ...
                <hr class="hidden-lg" />
                <div class="col-lg-6" style="background-color:#C9302C;">
                    <div class="widget-head-color-box navy-bg p-lg text-center">
                        <div class="m-b-md">
                            <h2 style="color:black;" class="font-bold no-margins">
                                Tino Fuhrmann
